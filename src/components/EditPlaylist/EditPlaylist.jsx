...
export default function EditPlaylist() {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      const response = await fetch(`https://moon-smy9.onrender.com/playList/update/${playlist._id}`, {
        method: 'PUT',
        headers: {
  ...
  return (
    <form onSubmit={handleUpdate} className="max-w-lg w-full">
      ...
      <center>
        <button
          type="submit"
          className="text-white bg-[#B5A5C9] font-medium rounded-lg text-sm w-[205px] py-2.5"
        >
