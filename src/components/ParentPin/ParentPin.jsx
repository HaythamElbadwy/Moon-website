...
export default function ParentPin() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            setIsLodaing(true)
            const response = await fetch('https://moon-smy9.onrender.com/lock/addParentPin', {
                method: 'PUT',
                headers: {
    ...
    return (
        <>
            <form className="max-w-lg w-full" onSubmit={handleSubmit}>
                ...
                <br />
                <center>
                    <button type="submit" className="text-white bg-[#B5A5C9] font-medium rounded-lg text-xm w-[205px]">
